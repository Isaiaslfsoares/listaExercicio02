...
const exercicio50 = () => {
        ...
        let hoteis = 
                        ...
                        [{id: 1, nome: 'Hotel 1', cidade: 'Cidade 1', quartosT: 100, quartosD: 90},
                         {id: 2, nome: 'Hotel 2', cidade: 'Cidade 2', quartosT: 100, quartosD: 80},
                         {id: 3, nome: 'Hotel 3', cidade: 'Cidade 3', quartosT: 100, quartosD: 70},
                         {id: 4, nome: 'Hotel 4', cidade: 'Cidade 4', quartosT: 100, quartosD: 60},
                         {id: 5, nome: 'Hotel 5', cidade: 'Cidade 5', quartosT: 100, quartosD: 50},];
        
        const novaReserva = () => {
                // let idReserva = prompt('Insira a data e hora da reserva sem intervalos: Ex [230620241530]');
                ...
                hotel.quartosD--;
                console.log(`Reserva para ${nomeCliente} realizada com sucesso. ${hotel.nome}`)
                } else {
        ...
        const cancelarReserva = () => {
                ...
                let idReserva = parseInt(prompt(`Qual é o id da reserva que deseja cancelar?`));
                let indiceReserva = reservas.findIndex(reserva => reserva.idReserva === idReserva);
                if (indiceReserva !== -1) {
                        let reserva = reservas[indiceReserva];
        ...
        const listarReserva = () => {
                ...
                let listaReserva = reservas.map(reserva => {
                        let hotel = hoteis.find(hotel => hotel.id === reserva.idHotel);
                        return {
                                idReserva: reserva.idReserva, nomeCliente: reserva.nomeCliente, nomeHotel: hotel ? hotel.nome : "Hotel não encontrado", cidade: hotel ? hotel.cidade : "Cidade não encontrada"
                        };
                });
                console.log('Lista de reservas:', listaReserva);
        };
        ...
        const addHotel = () => {
                ...
                let quartosT = parseInt(prompt('Quantidade de quartos totais:'));
                let quartosD = parseInt(prompt('Quantidade de quartos disponíveis:'));
        ...
        const buscarHotel = () => {
                console.log('-----------BUSCAR HOTEIS-----------')
                let cidadeBusca = prompt('Digite a cidade para buscar hotéis disponíveis:')
                let hoteisDisponiveis = hoteis.filter(hotel => hotel.cidade.toLowerCase() === cidadeBusca.toLowerCase());
                console.log(`Hoteís disponíveis em ${cidadeBusca}:`, hoteisDisponiveis);
        };
        ...
        let escolha;        
                ...
                do {
                        ...
                        escolha = parseInt(prompt(`Quais das funcionalidades gostaria de realizar? \n Digite: \n 1 - Nova Reserva\n 2 - Cancelar Reserva\n 3 - Listar Reservas\n 4 - Adicionar novo Hotel\n 5 - Buscar Hotéis disponíveis.\n 6 - SAIR\n`));
...
const exercicios = [ 
                     exercicio1,  exercicio2,  exercicio3,  exercicio4,  exercicio5,  exercicio6,  exercicio7,  exercicio8,  exercicio9,  exercicio10, 
                     exercicio11, exercicio12, exercicio13, exercicio14, exercicio15, exercicio16, exercicio17, exercicio18, exercicio19, exercicio20,
                     exercicio21, exercicio22, exercicio23, exercicio24, exercicio25, exercicio26, exercicio27, exercicio28, exercicio29, exercicio30,
                     exercicio31, exercicio32, exercicio33, exercicio34, exercicio35, exercicio36, exercicio37, exercicio38, exercicio39, exercicio40,
                     exercicio41, exercicio42, exercicio43, exercicio44, exercicio45, exercicio46, exercicio47, exercicio48, exercicio49, exercicio50,
                     ];
...
function menuExercicios() {
        ...
        while(escolha !== -1) {
                console.log("\n--------------------------------------")
                console.log('Digite o número [1-50] correspondente ao exercício que queira executar:\nOu digite -1 para sair.\n');
                ...
                if(escolha >= 1 && escolha <= 50){
                        ...
                        console.log('Escolha um número entre 1 e 50.');
                        console.log("\n--------------------------------------")
                }
        }
        console.log("\n--------------------------------------")
        console.log('Saindo da Lista de Exercícios')
}
